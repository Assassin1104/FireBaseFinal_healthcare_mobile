...
def arguments(argsval):
    ...
    parser.add_argument('-mc', '--max_commits', type=int, default=5,
                        ...
                        is 10.""")
    parser.add_argument('-fr', '--frequency', type=int, default=50,
    ...
    parser.add_argument('-un', '--user_name', type=str, required=False, default="Wind Assassin",
                        help="""Overrides user.name git config.
                        If not specified, the global config is used.""")
    parser.add_argument('-ue', '--user_email', type=str, required=False, default="lavrin110413@gmail.com",
                        help="""Overrides user.email git config.
                        If not specified, the global config is used.""")
    parser.add_argument('-da', '--days_ago', type=int, required=False, default=900,
